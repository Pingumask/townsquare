...
export default {
  ...
  computed: {
    availableReminders() {
      ...
      reminders.push({ role: "townsfolk", name: this.locale.modal.reminder.townsfolk });
      reminders.push({ role: "outsider", name: this.locale.modal.reminder.outsider });
      reminders.push({ role: "minion", name: this.locale.modal.reminder.minion });
      reminders.push({ role: "demon", name: this.locale.modal.reminder.demon });
      reminders.push({
        role: "custom",
