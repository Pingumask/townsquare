<template>
  <ul :class="nightType">
    <li class="headline">
      ...
      <font-awesome-icon class="button" :icon="preferences.hideOutOfPlay ? 'eye-slash' : 'eye'" @click="preferences.hideOutOfPlay = !preferences.hideOutOfPlay" />
    </li>
...
import { useGrimoireStore, useLocaleStore, usePlayersStore, useSessionStore, useUserPreferencesStore } from "@/stores";
